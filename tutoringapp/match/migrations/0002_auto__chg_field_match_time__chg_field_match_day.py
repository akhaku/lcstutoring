...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('match_match', 'time', self.gf('django.db.models.fields.TimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Match.time'
        raise RuntimeError("Cannot reverse this migration. 'Match.time' and its values cannot be restored.")
    ...
    models = {
        ...
        'match.match': {
            ...
            'day': ('django.db.models.fields.CharField', [], {'max_length': '1', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
