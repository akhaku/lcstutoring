...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('match_match', (
            ...
            ('location', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
    ...
    models = {
        ...
        'match.match': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
