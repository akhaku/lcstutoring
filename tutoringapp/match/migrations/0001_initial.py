...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('match_match', (
            ...
            ('tutor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='match', to=orm['tutors.Tutor'])),
            ('tutee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='match', to=orm['tutees.Tutee'])),
            ('matcher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('day', self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True)),
            ('time', self.gf('django.db.models.fields.TimeField')(null=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
    ...
    models = {
        ...
        'match.match': {
            ...
            'day': ('django.db.models.fields.IntegerField', [], {'max_length': '1', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
