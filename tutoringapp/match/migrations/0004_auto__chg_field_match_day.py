...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('match_match', 'day', self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'Match.day'
        db.alter_column('match_match', 'day', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=1))
